var  MAIN_MENU_FRAME = "menuFrame";
var  MAIN_DETAIL_FRAME = "windowFrame";

var  MENU_MAIN = "mainmenu.jsp";
var  MENU_GL_MAINT ="menu_gl_maint.jsp";
var  MENU_XACT ="menu_xact.jsp";
var  MENU_INVENTORY= "menu_inventory.jsp";
var  MENU_PROJECTS= "menu_projects_maint.jsp";   


var currentMenu           = "";     //Needed to track current menu
...
var offMenuColor      = "#green";  //Menu color with no Mouseover
var onMenuColor       = "#000000";  //Menu color with Mouseover
var onMenuTextColor  = "#000000";  //Menu Text color with mouseover
var offMenuTextColor   = "#FFFFFF";  //Menu Text color with NO mouseover
...
function startIt(menu,thisItem,level) {           //menu = menu to display,thisItem=coordinates of item to use,level=current depth of menus
  ...
  if (currentMenu != "" && currentMenu != "undefined" && currentMenu != thisItem.id) {
    currentMenu = eval("document.all('" + currentMenu + "')");
    currentMenu.style.background = offMenuColor;
  }

  thisItem.style.background = onMenuColor;
  currentMenu = thisItem.id;
...
function turnOff(thisItem) {           //menu = menu to display,thisItem=coordinates of item to use,level=current depth of menus

  thisItem.style.background = offMenuColor;
}
